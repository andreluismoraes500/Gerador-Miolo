export default {
  ...
  domingo:
    "text-rose-400 bg-rose-950/30 border-l-2 border-rose-500 shadow-[inset_5px_0_10px_rgba(244,63,94,0.1)]",
  button:
  ...
  techGrid:
    "bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]",
  badgeActive:
    "bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 inline-flex items-center gap-1.5 before:w-2 before:h-2 before:bg-emerald-400 before:rounded-full before:animate-pulse",
  badgeAlert:
    "bg-rose-500/10 text-rose-400 border border-rose-500/30 inline-flex items-center gap-1.5 before:w-2 before:h-2 before:bg-rose-400 before:rounded-full before:animate-ping",
  techDivider:
    "h-[1px] bg-gradient-to-r from-transparent via-cyan-500/40 to-transparent relative after:content-['<>'] after:absolute after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:bg-slate-950 after:px-2 after:text-[10px] after:text-cyan-500/60 after:font-mono",
  inputField:
    "bg-slate-900 border border-slate-800 text-slate-100 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/30 font-mono text-sm rounded transition-all duration-200 placeholder:text-slate-600",
  colors: {
    primary: "#06b6d4",
    secondary: "#22d3ee",
    background: "#0f172a",
