...
function PageHeader({
  ...
  return (
    <div className="text-center mb-4 shrink-0">
      ...
      {subtitulo && (
        <p className="text-[11px] uppercase tracking-[0.3em] text-gray-400 mt-1">
          {subtitulo}
        </p>
      )}
      <div
  ...
  return (
    <PageShell {...rest}>
      ...
      <div
        ...
        style={{ border: `1px solid ${primaryColor}44` }}
      >
        <div
          className="grid text-[9px] uppercase font-semibold text-white py-2 px-2"
          style={{
            gridTemplateColumns: "1.6fr 0.9fr 0.9fr 0.7fr 1fr",
    ...
    <PageShell {...rest}>
      ...
      >
        <div
          className="grid text-[9px] uppercase font-semibold text-white py-2 px-2"
          style={{
            gridTemplateColumns: "0.4fr 1.6fr 0.7fr 0.7fr 0.5fr 1fr",
            backgroundColor: primaryColor,
          }}
        >
    ...
    <PageShell {...rest}>
      ...
      >
        <div
          className="grid text-[9px] uppercase font-semibold text-white py-2 px-2"
          style={{
            gridTemplateColumns: "1fr 1.1fr 1fr 0.8fr 0.6fr",
            backgroundColor: primaryColor,
          }}
        >
          <span>Categoria</span>
    ...
    <PageShell {...rest}>
      ...
      >
        <div
          className="grid text-[9px] uppercase font-semibold text-white py-2 px-2"
          style={{
            gridTemplateColumns: "1.3fr 0.9fr 1fr 1fr",
            backgroundColor: primaryColor,
          }}
        >
          <span>Nome</span>
    ...
    <PageShell {...rest}>
      ...
      <div className="flex-1 flex flex-col gap-1.5 min-h-0">
        {HORARIOS_CRONOGRAMA.map((hora) => (
          <div
            key={hora}
            className="flex items-center gap-3 border-b border-gray-200 pb-1.5"
          >
            <span
