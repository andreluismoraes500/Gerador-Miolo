export const VERSICULOS_BIBLICOS = [
  ...
  "Bondade e misericórdia me seguirão todos os dias da minha vida. (Salmos 23:6)",
  ...
  "Alegrai-vos no Senhor, ó justos! (Salmos 33:1)",
  ...
  "O meu coração está firme, ó Deus! (Salmos 57:7)",
  "Em Deus faremos proezas. (Salmos 60:12)",
  "Bendize, ó minha alma, ao Senhor. (Salmos 103:1)",
  "O Senhor é misericordioso e compassivo, longânimo e cheio de bondade. (Salmos 103:8)",
  "Tu, Senhor, és bom e pronto a perdoar. (Salmos 86:5)",
  "Confia no Senhor e faze o bem. (Salmos 37:3)",
  ...
  "O homem bom tira o bem do bom tesouro do seu coração. (Lucas 6:45)",
  "O amor cobre todas as transgressões. (Provérbios 10:12)",
  "O justo é guiado pela sinceridade. (Provérbios 11:3)",
  ...
  "O que adianta o homem ganhar o mundo inteiro e perder a sua alma? (Mateus 16:26)",
  "Se dois de vós concordarem na terra acerca de qualquer coisa que pedirem, ser-lhes-á concedida. (Mateus 18:19)",
  ...
  "Tudo posso naquele que me fortalece. (Filipenses 4:13)", // já tem, mas pode repetir
  "Não andem ansiosos por coisa alguma, mas em tudo, pela oração e súplicas, apresentem seus pedidos a Deus. (Filipenses 4:6)",
  "E a paz de Deus, que excede todo entendimento, guardará os vossos corações. (Filipenses 4:7)",
  "Tudo o que for verdadeiro, tudo o que for respeitável, tudo o que for justo... pensem nessas coisas. (Filipenses 4:8)",
  "Porque a graça de Deus se manifestou, trazendo salvação a todos. (Tito 2:11)",
  "Aquele que começou a boa obra em vós a aperfeiçoará até o dia de Cristo Jesus. (Filipenses 1:6)",
  ...
  "O Senhor é o meu ajudador, e não temerei. (Hebreus 13:6)",
  ...
  "Nada nos separará do amor de Deus. (Romanos 8:38-39)",
  "Portanto, se alguém está em Cristo, é nova criatura. (2 Coríntios 5:17)",
  ...
  "Porque o Senhor teu Deus é Deus de deuses e Senhor dos senhores. (Deuteronômio 10:17)",
  "O Senhor te abençoará e te guardará. (Números 6:24)",
  "O Senhor fará resplandecer o seu rosto sobre ti. (Números 6:25)",
  "O Senhor te dará a paz. (Números 6:26)",
  "Eis que eu envio o meu anjo diante de ti. (Êxodo 23:20)",

  // Salmos adicionais
  "O Senhor é a porção da minha herança. (Salmos 16:5)",
  "Tu me farás ver os caminhos da vida. (Salmos 16:11)",
  "A lei do Senhor é perfeita e refrigera a alma. (Salmos 19:7)",
  "Os céus declaram a glória de Deus. (Salmos 19:1)",
  "O Senhor é a minha força e o meu cântico. (Salmos 118:14)",
  "Alegrei-me quando me disseram: Vamos à casa do Senhor. (Salmos 122:1)",
];
