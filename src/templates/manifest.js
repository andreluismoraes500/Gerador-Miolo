...
export const TEMPLATE_MANIFEST = {
  ...
  cadernoReceitas: { nome: "Caderno de Receitas Culinárias" },
  bulletJournal: { nome: "Bullet Journal / Caderno Pontilhado" },
  babyBook: { nome: "Diário de Bebê" },
  cadernoIdiomas: { nome: "Caderno de Idiomas" },
  cadernoConcursos: { nome: "Caderno de Concursos / ENEM" },
  cadernoInvestimentos: { nome: "Caderno de Investimentos" },
